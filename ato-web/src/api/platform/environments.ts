...
} from 'types/platform/environments';
...
export const updatePlatformEnvironment = async ({ id, data }: { id: string; data: UpdatePlatformEnvironmentDto }): Promise<PlatformEnvironment> => {
