  ...
  return (
    <MainCard title="System Settings" content={false}>
      <Box sx={{ flexGrow: 1, bgcolor: 'background.paper', display: 'flex', height: '100%', minHeight: 'calc(100vh - 200px)' }}>
        ...
        >
          <Tab icon={<IconSettings size={18} />} iconPosition="start" label="General" {...a11yProps(0)} />
          <Tab icon={<IconDatabaseImport size={18} />} iconPosition="start" label="Discovery Engine" {...a11yProps(1)} />
        </Tabs>
