  ...
  return (
    <MainCard title="Account Settings" content={false}>
      <Box sx={{ flexGrow: 1, bgcolor: 'background.paper', display: 'flex', height: '100%', minHeight: 'calc(100vh - 200px)' }}>
        ...
        >
          <Tab icon={<IconUser size={18} />} iconPosition="start" label="Profile" {...a11yProps(0)} />
          <Tab icon={<IconLock size={18} />} iconPosition="start" label="Security" {...a11yProps(1)} />
          <Tab icon={<IconSettings size={18} />} iconPosition="start" label="Preferences" {...a11yProps(2)} disabled />
        </Tabs>
