...
export default function BajajAreaChartCard() {
  ...
  const secondary800 = (theme.vars || theme).palette.secondary[800];
  ...
  useEffect(() => {
    setChartOptions({
      ...bajajChartOptions,
      chart: { ...bajajChartOptions.chart, fontFamily: fontFamily } as any,
      colors: [secondary800],
      fill: {
        gradient: {
          colorStops: [
  ...
  return (
    <Card sx={{ bgcolor: 'secondary.light', mt: -1 }}>
      ...
      <Chart options={chartOptions as any} series={series} type="area" height={95} />
    </Card>
  );
}
