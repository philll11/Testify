...
describe('System Config Auth (e2e)', () => {
    ...
    beforeAll(async () => {
        ...
        const createPersona = async (recordId: string, roleName: string, perms: string[], email: string) => {
    ...
    describe('PATCH /system/config/:key', () => {
        ...
        it('should succeed for a user with SYSTEM_CONFIG_EDIT permission', async () => {
            ...
            // Verify
            const updated = await systemConfigRepository.findOneBy({ key: testConfigKey });
